...
public class CustomerAge {
   public static void main(String[] args) {
      ...
      Customer customer1 = new Customer(); // Create first Customer object
      Customer customer2 = new Customer(); // Create second Customer object
      
      // Declare name and age variables
      String name;
      int age;
      
      // Read name and age input for customer 1
      name = scnr.next();
      age = scnr.nextInt();
      
      // Set customer 1 name and age using mutator methods
      customer1.setName(name);
      customer1.setAge(age);

      // Read name and age input for customer 2
      name = scnr.next();
      age = scnr.nextInt();
      
      // Set customer 2 name and age using mutator methods
      customer2.setName(name);
      customer2.setAge(age);

      System.out.println("Customer that is older:");
      
      // Compare ages and output info for older customer
