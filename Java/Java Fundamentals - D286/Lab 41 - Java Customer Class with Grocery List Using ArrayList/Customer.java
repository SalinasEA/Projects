...
public class Customer {
   ...
   // Declare Grocery ArrayList to hold Grocery objects
   public ArrayList<Grocery> Grocery = new ArrayList<Grocery>();
   
   // Return the Grocery ArrayList
   public ArrayList<Grocery> getGroceryList() {
      return Grocery;
   }
   
   // Add a Grocery object to the Grocery ArrayList
   public void addGrocery(Grocery grocery) {
      Grocery.add(grocery);
   }
   
   // Accessor and mutator methods for id and name
   public int getId() {
      return id;
   }
